...
|              | *Daikon 5.0.x* | Daikon 5.1.x | Daikon 5.[2-4].x | Daikon 5.5.x |
|--------------|----------------|--------------|------------------|--------------|
| Spring Boot  | 2.3.7          | 2.3.7        | 2.3.8            | 2.3.9        |
| Spring Cloud | Hoxton SR9     | Hoxton SR9   | Hoxton SR10      | Hoxton SR10  |
| Jackson      | 2.11.3         | 2.11.3       | 2.11.4           | 2.11.4       |
